//
//  WlyxqkTableViewController.swift
//  ITSC
//
...
class WlyxqkTableViewController: UITableViewController {

    var items:[ListItem] = []
    var num: Int = 1
    let defaultUrl = URL(string: "https://itsc.nju.edu.cn/wlyxqk/list.htm")
    ...
    func loadDataFromUrl(){
        ...
        if num == 1 {
            ...
            url = URL(string: "https://itsc.nju.edu.cn/wlyxqk/list\(num).htm")!
        }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "wlyxqkCell", for: indexPath) as! ListTableViewCell
