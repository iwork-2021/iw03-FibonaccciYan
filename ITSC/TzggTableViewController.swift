...
class TzggTableViewController: UITableViewController {
    ...
    var items:[ListItem] = []
    var num: Int = 1
    let defaultUrl = URL(string: "https://itsc.nju.edu.cn/tzgg/list.htm")
    ...
    func loadDataFromUrl(){
        ...
        if num == 1 {
            ...
            url = URL(string: "https://itsc.nju.edu.cn/tzgg/list\(num).htm")!
        }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "tzggCell", for: indexPath) as! ListTableViewCell
